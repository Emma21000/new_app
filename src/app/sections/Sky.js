...
export default function Sky({data}) {
  return (
    <div className="w-full h-full bg-[#b18673]">
        ...
        <div className="flex items-start justify-evenly py-18 text-white">
            ...
            <div className="flex flex-col my-6 gap-y-6">
                <Link className="bg-white py-4 px-12 text-4xl text-[#b18673]  border-2 border-transparent hover:bg-[#b18673] hover:border-white hover:text-[#3e2b24] duration-150 transition-all" href='#'>{data.link.title}</Link>
